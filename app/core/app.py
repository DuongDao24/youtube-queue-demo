...
CHANGELOG (v01.6.2):
- Persistent storage in /app/core/data (JSON + CSV) so state survives restarts.
...
- Clean repo layout: only README at repo root; all code lives under /app/.

NOTES:
- Point Flask to /app/templates and /app/static via absolute paths derived from this file.
"""
...
# -----------------------------
# Flask app (points to /app/templates & /app/static)
# -----------------------------
